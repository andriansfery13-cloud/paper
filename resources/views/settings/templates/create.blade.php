...
@section('content')
    <div class="max-w-6xl mx-auto">
        <form action="{{ route('settings.templates.store') }}" method="POST">
            @csrf
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" required
                                    ...
                                    placeholder="Contoh: Invoice Modern Biru">
                            </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-sm border overflow-hidden h-full flex flex-col">
                        <div class="p-4 border-b bg-gray-50 flex justify-between items-center">
                            ...
                            <span class="text-xs text-gray-500">Gunakan Tailwind CSS untuk styling</span>
                        </div>
                        <div class="flex-grow p-0">
                            <textarea name="html_content"
                                class="w-full h-[600px] p-4 font-mono text-sm focus:outline-none focus:ring-0 border-0"
